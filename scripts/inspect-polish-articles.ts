    ...
    messages: [
      {
        ...
        content: [
          ...
          'НЕ мелодрама, НЕ истеричный восторг, НЕ эмодзи, НЕ пустое «вау», НЕ guys/ребята.',
          ...
          'Stock-фразы банятся кодом — не воспроизводи их.',
      ...
      },
      {
        ...
        content: [
          ...
          'content: ОБЯЗАТЕЛЬНО 150–200 слов, русский, спокойное ясное product-объяснение, уникальный opener.',
          'Убери патос/игривость/хайп; сохрани интерес через пользу. Разверни: хук → что это → 3–5 выгод → цена/статус → спокойный финал.',
