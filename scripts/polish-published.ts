    ...
    messages: [
      {
        role: 'system',
        content: [
          'Ты спокойный компетентный editor-in-chief SmartProto — polish agent вне publish-flow.',
          'Перепиши карточку: убери патос/игривость/хайп; ясное взрослое product-объяснение.',
          ...
          'Тон: ясный, конкретный, без давления купить ASAP; строго 150–200 слов.',
          ...
          'Без «вау/wow/guys/ребята/look at this», эмодзи, канцелярита и TikTok-сленга.',
          'Хук: польза / сценарий / сравнение / факт — без восклицаний.',
          'Структура: продукт → как работает → цена/доступность (или «не объявлено») → ограничения.',
      ...
      },
      {
        ...
        content: [
          ...
          '',
          'content: 150–200 слов, русский, спокойное ясное product-объяснение, мужской голос автора, уникальный opener.',
          'Убери патос/хайп и женские формы 1-го лица; сохрани интерес через пользу. НЕ копируй зачины. Избегай openers:',
          ...(avoidOpeners.length
