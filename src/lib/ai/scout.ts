...
const SCOUT_SYSTEM_PROMPT = [
  ...
  '',
  'Жёсткий reject ВСЕГДА (score=0, interesting=false, productType="none"), если:',
  '- нет конкретного покупаемого продукта/устройства (buy или preorder);',
  ...
  '- абстрактные новости / советы / гайды без одного явного товара;',
