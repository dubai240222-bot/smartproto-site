...
const SCOUT_SYSTEM_PROMPT_GADGET = [
  ...
  '',
  'PRIORITY (SP-A-054): бери САМОЕ интересное — unusual form factor, сильный wow, редкая находка.',
  'REJECT overplayed / worn-out даже если buyable: iPhone/Galaxy/Pixel color refresh, бесконечные',
  'flagship rumor/leak циклы, generic power banks / chargers без новой функции, то что люди уже сто раз слышали.',
  'Skip stale commodity mass products — лучше пропустить тик, чем опубликовать заезженное.',
  '',
  ...
  '- overplayed mass: цвет флагмана / endless rumor-leak / commodity charger без новизны (SP-A-054);',
