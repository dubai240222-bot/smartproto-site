...
const EDITOR_SYSTEM_PROMPT = [
  ...
  '',
  'ЗАГОЛОВОК (SP-A-071b): мягкий curiosity-hook по РЕАЛЬНОМУ факту материала — вопрос, сценарий или факт-хук.',
  'Не делай все заголовки вопросами подряд: чередуй формы. Без «!». Без фейка и без ложного крика.',
  'Плохо: «Redmi 17 5G: смартфон с батареей 7500 мАч» (это дубль первого предложения / карточка товара).',
  'Хорошо: «А хватит ли заряда на неделю?» ИЛИ «Redmi 17 5G ставит на автономность» —',
  'а точный факт модели идёт в ПЕРВОМ абзаце текста, не как сухой title-шаблон.',
    ...
    messages: [
      { role: 'system', content: EDITOR_SYSTEM_PROMPT },
      {
        ...
        content: [
          ...
          '',
          'title: русский, до 90 символов; мягкий curiosity-hook по реальному факту;',
          'можно вопрос, сценарий или факт-хук — НЕ все titles обязаны быть вопросами;',
          'НЕ шаблон «Бренд Модель: спека»; НЕ дубль первого предложения; без «!».',
          'Пример: «А хватит ли заряда на неделю?» или «Redmi 17 5G ставит на автономность» —',
          'вместо «Redmi 17 5G: батарея 7500 мАч».',
